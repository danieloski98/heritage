...
export default function Home(props: any) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <Container width="100%" height="80%" bgColor="white" justifyContent="flex-start" alignItems="center">

                <Container width="100%" height="50%"  bgColor="white">
                    <PagerView style={{ flex: 1, width: '100%', height: '100%' }} initialPage={page} scrollEnabled transitionStyle="scroll" onPageSelected={(e) => setPage(e.nativeEvent.position)}>
                        ...
                        <Container width="100%" height="100%" key="1" alignItems="center" justifyContent="flex-start" paddingLeft="10px" paddingRight="10px" bgColor="white">
                            <Container width="100%" height="80%" alignItems="center" bgColor="white">
                                <Image source={require('../../../../assets/images/phone.png')} resizeMode="contain" style={{ width: '50%', height: '100%' }} />
                            </Container>
                            <Text textAlign="center" color="black" fontSize="22px" fontWeight="bold">Buy Cryptocurrency Instantly</Text>
                            <Text textAlign="center" fontSize="14" marginTop="5">You can buy cryptocurrency seamlessly from Heritage Exchange</Text>
                        </Container>

                        <Container width="100%" height="100%" alignItems="center" justifyContent="center"key="2" paddingLeft="10px" paddingRight="10px" bgColor="white">
                            <Container width="100%" height="80%" alignItems="center" bgColor="white">
                                <Image source={require('../../../../assets/images/phone.png')} resizeMode="contain" style={{ width: '50%', height: '100%' }} />
                            </Container>
                            <Text textAlign="center" color="black" fontSize="22px" fontWeight="bold">Sell Cryptocurrency On The Go</Text>
                            <Text textAlign="center" fontSize="14" marginTop="5">You can sell cryptocurrency seamlessly from Heritage Exchange</Text>
                        </Container>

                        <Container width="100%" height="100%" alignItems="center" justifyContent="center" key="3" paddingLeft="10px" paddingRight="10px" bgColor="white">
                            <Container width="100%" height="80%" alignItems="center" bgColor="white">
                                <Image source={require('../../../../assets/images/phone.png')} resizeMode="contain" style={{ width: '50%', height: '100%' }} />
                            </Container>
                ...
                {/* bottom section */}
                <Container flexDirection="row" width="100%" height="20%" justifyContent="space-between" paddingLeft="20px" paddingRight="20px" bgColor="white">
