...
export default function WalletsBanks() {
    return (
        <View style={{ flex: 1, paddingHorizontal: 20, paddingTop: 30, paddingBottom: 200, backgroundColor: theme.light }}>
            <Text fontSize="20px" color="black" fontWeight="bold">My Wallet Addresses</Text>

            <Container width="100%" height="80px" justifyContent="center" alignItems="flex-start" marginTop="20px" bgColor={theme.light}>
